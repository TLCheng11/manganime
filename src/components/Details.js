      ...
      {!currentUser.username ? (
        ...
        <div>
          ...
          {!favorited ? (
            ...
            <button className="delete-button" onClick={removeCollection}>
      ...
      <div id="details-container">
        ...
        <div id="details">
          ...
          {attributes.youtubeVideoId ? (
            <iframe
              src={`//youtube.com/embed/${attributes.youtubeVideoId}`}
              width="65%"
              height="45%"
              allowFullScreen
            ></iframe>
          ...
          {attributes.averageRating ? (
            <p>
              <span>Rating: </span> {attributes.averageRating}
            </p>
          ) : null}
          ...
          {links.self ? (
            <p>
              <a href={links.self.replace("/api/edge", "")} target="_blank">
                Read more!
              </a>
            </p>
          ) : null}
